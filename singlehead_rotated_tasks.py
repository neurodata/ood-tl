...
def run_experiment(exp_conf, gpu):
    ...
    for angle in exp_conf['angles']:
        ...
        dfi.to_csv('{}/{}_{}_{}_{}_{}.csv'.format(exp_conf['save_folder'], exp_conf['dataset'], exp_conf['net'], exp_conf['exp_name'], angle, setting))
    
    print("Saving bulk results...")
    df.to_csv('{}/{}_{}_{}_{}.csv'.format(exp_conf['save_folder'], exp_conf['dataset'], exp_conf['net'], exp_conf['exp_name'], setting))
