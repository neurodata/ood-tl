...
# (Optimal Task Aware) T2 vs T3 + SmallConv + Aug + Conventional Batches (bs = 128, e = 100) ()
python singlehead_dual_tasks.py --exp_id exp --in_task 2 --out_task 3 --task_aware --tune_alpha --net smallconv --augment --custom_sampler --epochs 100 --batch_size 128 --reps 10 --gpu cuda:2 --makefolder