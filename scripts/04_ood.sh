...
python3 train_singlehead.py -m seed=10 reps=10 deploy=True tag=04_ood/singlehead_agnostci_mixed_cinic loss.group_task_loss=False task.custom_sampler=False task.m_n=0,0.5,1,2,4,6,8,10,12,15,20,25,30 task.augment=False task.dataset=cinic_img task.n=10
