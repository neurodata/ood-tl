...
def SmallConv(NUM_CLASSES=10, in_channels = 1):
    return nn.Sequential(
            nn.Conv2d(in_channels, 80, kernel_size=3, bias=False),
            nn.ReLU(),
            nn.MaxPool2d(2, 2),
...
def get_model(model_type, in_channels = 3, NUM_CLASSES=10):
    model_mapper = {"resnet9": ResNet9, "lenet": LeNet, "resnet50":ResNet50, "resnet18":ResNet18, "smallconv":SmallConv}
